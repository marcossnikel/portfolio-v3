      ...
      <div className="max-w-4xl">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
            Talks, presentations, and workshops I've given at conferences and events.
          </p>
        </div>
        ...
        <div className="space-y-12">
          <div className="p-8 border border-gray-200 dark:border-gray-800 rounded-2xl hover:border-gray-300 dark:hover:border-gray-700 transition-colors duration-200">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              I'm preparing content about my speaking engagements and presentations. 
              Stay tuned for updates on my upcoming talks and past presentations!
            </p>
          </div>
        </div>
      </div>
